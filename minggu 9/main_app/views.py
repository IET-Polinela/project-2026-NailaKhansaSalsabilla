...
class ReportListView(ListView):
    ...
    def get_queryset(self):
        # Supaya halaman reports tidak lag, data awal dibatasi 50 laporan terbaru
        return Report.objects.all().order_by('-created_at')[:50]
...
class UpdateReportView(AdminRequiredMixin, UpdateView):
    model = Report
    form_class = ReportForm
...
class ReportSearchView(View):
    def get(self, request):
        ...
        # Supaya live search tidak berat, hasil JSON dibatasi 50 data
        reports = reports[:50]
